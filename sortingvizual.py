...
class DrawInformation:
    ...
    GRADIENTS = [(33, 147, 176), (109, 213, 237), (224, 78, 254)]
    ...
    def __init__(self, width, height, lst):
        ...
        img = pygame.image.load("popye.png")
...
def draw(draw_info, algo_name, ascending):
    ...
    title = draw_info.LARGE_FONT.render(
        f"{algo_name} - {'Ascending' if ascending else 'Descending'}", 1, (2, 218, 253)
    )
    ...
    sorting = draw_info.FONT.render(
        "I - Insertion Sort | B - Bubble Sort | S - Selection Sort | M - Merge Sort",
        1,
        draw_info.BLACK,
    )
        ...
        if ascending:
            ...
            for i in range(currentIdx + 1, len(lst)):
                ...
                draw_list(
                    draw_info,
                    {
                        currentIdx: draw_info.GREEN,
                        i: draw_info.YELLOW,
                        smallestIdx: draw_info.RED,
                    },
                    True,
                )
                yield True
            ...
            draw_list(
                draw_info,
                {currentIdx: draw_info.GREEN, smallestIdx: draw_info.RED},
                True,
            )
            yield True
        else:
            ...
            draw_list(
                draw_info,
                {currentIdx: draw_info.GREEN, largestIdx: draw_info.RED},
                True,
            )
            yield True
        currentIdx += 1
...
def main():
    ...
    draw_info = DrawInformation(1100, 600, lst)
    sorting = False
    ascending = True
